...
This example demonstrates how to do model selection in a feature
representation pipeline using a grid search
"""
...
def plot_grid_search(cv_results, grid_param_1, grid_param_2,
    ...
    # Param1 is the X-axis, Param 2 represented as different curve (color line)
...
# note that if you want to set a parameter to a single value, it will
# still need to be as a list
