...
pipe = Pype([('seg', Segment(width=100, step=100, order='C')),
             ('crnn', KerasClassifier(build_fn=crnn_model, epochs=4,
                                      batch_size=256,
...
# keras wrapper when fit is called, this approach won't work with
# a more complex estimator pipeline, in which case a callable class with
# the desired properties should be made passed to build_fn
